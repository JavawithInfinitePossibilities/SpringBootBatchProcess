...
public class DBInputAppJobConfiguration {
	...
	public Step step1() throws Exception {
		return stepBuilderFactory.get("stepReaderCustomer1Start").<Customer, Customer>chunk(10)
	...
	public Job listenerJob() throws Exception {
		return jobBuilderFactory.get("CustomCustomerReadJobConfiguration").start(step1()).build();
	}
